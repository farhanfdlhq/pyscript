...
<head>
    ...
    <!-- Font Awesome Icons -->
    <link rel="stylesheet" href="{{ URL::asset('assets\dashboard\plugins\fontawesome-free\css\all.css') }}">
    <!-- Theme style -->
...
<body class="hold-transition sidebar-mini">
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            <!-- Brand Logo -->
            <a href="dashboard2" class="brand-link">
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    <div class="image">
                        <img src="assets/dashboard/dist/img/user2-160x160.jpg" class="img-circle elevation-2"
                            alt="User Image">
                    </div>
                    <div class="info">
        ...
        <footer class="main-footer">
            ...
            <!-- Default to the left -->
            <strong>Copyright &copy; 2024-2026 <a href="https://adminlte.io">Dashboard Admin</a>.</strong> All rights
            reserved.
        </footer>
    </div>
    <!-- ./wrapper -->
    ...
    <script src="{{ URL::asset('assets\dashboard\plugins/datatables-responsive/js/dataTables.responsive.min.js') }}">
    </script>
    <script src="{{ URL::asset('assets\dashboard\plugins/datatables-responsive/js/responsive.bootstrap4.min.js') }}">
    </script>
