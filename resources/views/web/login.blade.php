...
<head>
    ...
    <!-- Theme style -->
    <link rel="stylesheet" href="{{ URL::asset('assets\dashboard\dist/cs\adminlte.min.css') }}">
</head>
    ...
    <div class="login-box">
        ...
        <div class="card card-outline card-primary">
            <div class="card-header text-center">
                <a href="{{ URL::asset('assets/dashboard/index2.html') }}" class="h1"><b>Admin</b>LTE</a>
            </div>
            <div class="card-body">
                <p class="login-box-msg">Sign in to start your session</p>

                <form action="{{ URL::asset('assets/dashboard/index3.html') }}" method="post">
